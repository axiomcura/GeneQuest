...
class TestDependencies(unittest.TestCase):
    ...
    def test_numpy_import(self):
        ...
        try:
            ...
            import_check = False
            self.logger.error("test_numpy_import import_check FAILED - unable to import numpy")
        ...
        if version_check is False:
            self.logger.error("test_numpy_import version_check: FAILED - incorrect version installed")
            self.assertEqual(True, import_check)
    ...
    def test_packaging_import(self):
        ...
        try:
            ...
            import_check = False
            self.logger.error("test_packaging_import: FAILED - unable to import packaging")
            self.assertEqual(True, import_check)
    ...
    def test_pandas_import(self):
        ...
        if version_check is False:
            self.logger.error("test_pandas_import version_check: FAILED - incorrect version installed")
            self.assertEqual(True, import_check)
    ...
    def test_pandas_import(self):
        ...
        try:
            ...
            import_check = False
            self.logger.error("test_memory_profiler_import: FAILED - unable to import memory_profiler")
            self.assertEqual(True, import_check)
        ...
        if version_check is False:
            self.logger.error("test_memory_profiler_import version_check: FAILED - incorrect version installed")
            self.assertEqual(True, import_check)
